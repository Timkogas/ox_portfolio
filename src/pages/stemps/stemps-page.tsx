    ...
    <div className="flex flex-col min-h-screen bg-white overflow-x-clip">
      ...
      <section className="relative w-full pb-[70px] max-lg:pb-[40px] overflow-x-clip">
        <img
          ...
          role="presentation"
          loading="lazy"
          className="absolute right-[calc((100vw-min(100vw,1440px))/2+175px)] top-[-8px] w-[240px] h-auto pointer-events-none max-lg:hidden"
          onError={(e) => {
            e.currentTarget.style.display = "none";
          }}
        />
        <Content className="flex flex-col gap-[48px]">
          <section className="relative bg-[var(--stemps-card-bg)] rounded-[10px] p-[24px] flex flex-col gap-[24px]">
